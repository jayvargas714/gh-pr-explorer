...
TEAM_REVIEW_TEMPLATE = {
    "steps": [
        ...
        {"id": "fresh", "type": "freshness_check", "config": {"agent": "claude-sonnet-low"}, "position": {"x": 900, "y": 200}},
...
SELF_REVIEW_TEMPLATE = {
    "steps": [
        ...
        {"id": "fresh", "type": "freshness_check", "config": {"agent": "claude-sonnet-low"}, "position": {"x": 1050, "y": 200}},
