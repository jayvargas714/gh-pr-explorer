...
# disputed blocking count reached the threshold, the review was posted as a
# COMMENT and the PR was disarmed pending a human.
...
class AutoVerdictsDB:
    ...
    def finalize(
        ...
        with self.db.connection() as conn:
            ...
            """, (
                outcome, event, reason,
                tallies.get("blocking"), tallies.get("non_blocking"),
