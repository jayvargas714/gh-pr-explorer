    ...
    try {
      ...
      if (inQueue) {
        ...
        addToQueueStore({
          ...
          nonBlockingPosted: false,
          blockingPostedCount: null,
          blockingFoundCount: null,
          nonBlockingPostedCount: null,
          nonBlockingFoundCount: null,
          blockingIssueTitles: null,
          nonBlockingIssueTitles: null,
          isFollowup: false,
          revLog: [],
